...
void R3BFibersipmMapped2Cal::ReadMapping(TString mappingfile){
 ...
 ifstream mapping;
  ...
  if(mapping.good()){
    ...
    LOG(INFO)  << "R3BFibersipmMapped2Cal NO Mapping file :  -> Setting all channels to y-direction " << FairLogger::endl;
