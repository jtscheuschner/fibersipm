...
#include "R3BFiberSIPMReader.h"
#include "R3BFi4MappedItem.h"

extern "C" {
#include "ext_data_client.h"
#include "ext_h101_fisipm.h"
}

R3BFiberReader::R3BFiberReader(EXT_STR_h101_FIBSIPM* data, UInt_t offset)
	: R3BReader("R3BFiberSIPMReader")
	, fData(data)
	, fOffset(offset)
	, fLogger(FairLogger::GetLogger())
    , fArray(new TClonesArray("R3BFibSIPMMappedItem"))
{
}

R3BFiberSIPMReader::~R3BFiberSIPMReader()
{}

Bool_t R3BFiberSIPMReader::Init(ext_data_struct_info *a_struct_info)
{
	int ok;
...
Bool_t R3BFiberSIPMReader::Read()
{
...
void R3BFiberSIPMReader::Reset()
{
  // Reset the output array
  fArray->Clear();
}

ClassImp(R3BFiberSIPMReader)
